                ...
                data.map(item => {
                    ...
                    return (
                        <div className='card home-card' key={_id}>
                            ...
                            <img style={{ width: "40px", height: "40px", borderRadius: '20px', float: "left", marginRight: "5px" }}
                                    src={pic ? pic : "loading"} />
                                <Link to={state._id.toString() !== postedBy._id.toString() ? `/profile/${postedBy._id}` : `/profile`}>
                            ...
                            <div className='card-content'>
                                ...
                                <p>{body}</p>
                                {
                                    comments.map(records => {
                                        ...
                                        console.log('records.postedBy.pic',records.postedBy.pic);
                                        ...
                                        return (
                                            <>
                                                ...
                                                <h6 key={records._id}>
                                                <img style={{ width: "20px", height: "20px", borderRadius: '10px', float: "left",marginRight:'5px' }}
                                                    src={pic ? pic : "loading"} />
                                                    <span style={{ fontWeight: 500 }}>{records.postedBy.name} </span> {records.text} <span>  {
